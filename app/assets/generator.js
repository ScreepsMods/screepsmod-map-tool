...
export function getTerrain (room) {
  return terrainCache[room] || null
}
export function setTerrain (room, terrain) {
  terrainCache[room] = { terrain }
}
...
/**/
export async function generateRoom (roomName, opts) {
  opts = opts || {}
  ...
  const neighborRooms = await Promise.all([
